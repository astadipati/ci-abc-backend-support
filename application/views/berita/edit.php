                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <?php
                            ...
                            echo form_open_multipart('berita/edit', 'role="form" class="form-horizontal"');
                            echo form_hidden('id', $data_berita['id']);
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" value="<?php echo $data_berita ['judul_berita']?>" name="judul_berita" placeholder="Judul Berita" id="form-field-1" class="form-control">
                                    </div>    
                                </div>                            
                            </div>            
                            <br>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="required-field-block">
                                    <input type="date" value="<?php echo $data_berita ['tanggal_posting']?>" name="tanggal_posting" placeholder="Tanggal Berita" id="form-field-1" class="form-control">
                                    </div>    
                                </div>                            
                            </div>            
                            <br>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" value="<?php echo $data_berita ['penulis']?>" name="penulis" placeholder="Nama Penulis" id="form-field-1" class="form-control">
                                    </div>    
                                </div>                            
                            </div>            
                            <br>
